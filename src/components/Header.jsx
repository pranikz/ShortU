...
const Header = () => {
  return (
    <header>
      <div className="">
        <div className="bg-indigo-400 rounded shadow-lg py-5 px-7">
              ...
              <div className="relative cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 ">
                <a href="/">
                  <svg
                    ...
                    className="octicon octicon-mark-github v-align-middle bg-white rounded-full border-2 border-black "
                  >
                    <path
                      fillRule="evenodd"
